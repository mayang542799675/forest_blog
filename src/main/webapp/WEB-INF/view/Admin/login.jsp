...
<head>
    ...
    <style type="text/css">
        body{
            ...
            background: url(https://20190830beijing.oss-cn-beijing.aliyuncs.com/loginBg1.jpg);
            width:100%;
            height:100%;
        }
        .login h1 a {
...
<div id="login">
    ...
    <form name="loginForm" id="loginForm"  method="post">
        ...
        <%--<p class="forgetmenot"><label for="rememberme"><input name="rememberme" type="checkbox" id="rememberme" value="0" checked /> 记住密码</label></p>--%>
        <p class="submit">
    ...
    <p id="backtoblog"><a href="/" style="color: #000000">&larr; 返回到狗蛋的窝</a></p>
